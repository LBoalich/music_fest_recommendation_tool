...
def find_artists(root_node):
    ...
    while len(nodes_to_visit) > 0:
        ...
        if current_node.value.lower().startswith(artist_input) and current_node.value not in camping and current_node.value not in non_camping and current_node.value != "Camping" and current_node.value != "Non-Camping":
